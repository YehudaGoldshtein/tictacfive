...
class player_agent:
    ...
    def get_next_move(self, _game_state):
        ...
        curr_state = game_state(_game_state.get_grid().copy(), _game_state.get_curr_player(),
                                _game_state.get_last_move(), _game_state.get_used_cells())
        ...
        return best_state.get_last_move()
